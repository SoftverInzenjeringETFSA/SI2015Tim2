...
public class ManagementMainWindow {
	...
	private void initialize() {
		...
		lblZaOvuGodinu.setBounds(10, 346, 296, 26);
		...
		panel_1.setBounds(423, 44, 333, 279);
		...
		scrollPane_1.setBounds(54, 50, 238, 131);
		...
		btnPogledajDetalje.setBounds(153, 245, 139, 23);
		...
		label_7.setBounds(299, 352, 30, 14);
		panel.add(label_7);
		
		JLabel lblDanaGodinjegOdmora = new JLabel("dana godišnjeg odmora");
		lblDanaGodinjegOdmora.setForeground(new Color(128, 0, 0));
		lblDanaGodinjegOdmora.setFont(new Font("Comic Sans MS", Font.ITALIC, 13));
		lblDanaGodinjegOdmora.setBounds(327, 349, 140, 20);
		panel.add(lblDanaGodinjegOdmora);
		...
		dateChooser.setBounds(140, 95, 139, 20);
		...
		btnDodajZaposlenika.setBounds(40, 356, 138, 23);
		...
		panel_8.setBounds(482, 27, 258, 305);
		panel_7.add(panel_8);
		...
		panel_9.setBounds(26, 27, 349, 305);
		panel_7.add(panel_9);
		...
		btnSpasiIzmjene.setBounds(482, 356, 124, 23);
		...
		btnObriiSektor.setBounds(616, 356, 124, 23);
		panel_7.add(btnObriiSektor);
		
		JButton btnSpasiPromjene_1 = new JButton("Spasi promjene");
		btnSpasiPromjene_1.setBounds(211, 356, 124, 23);
